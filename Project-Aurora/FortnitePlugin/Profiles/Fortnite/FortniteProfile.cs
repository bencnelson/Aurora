...
namespace Aurora.Profiles.Postman{
    ...
    public class PostmanProfile : ApplicationProfile {

        public PostmanProfile() : base() { }
        ...
        public override void Reset() {
            ...
            //new Layer("Score", new AnimationLayerHandler {
            //        Properties = new AnimationLayerHandlerProperties {
            //            _AnimationMix = CreateCircleAnimation(Color.FromArgb(255, 170, 255), 5),
